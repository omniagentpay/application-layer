...
const LoginPage = () => {
  ...
  useEffect(() => {
    // DEV BYPASS: Skip login, go directly to app
    if (devAuthEnabled) {
      console.log('[DEV AUTH BYPASS] Skipping login, redirecting to /app');
      navigate('/app');
      return;
    }
  ...
  }, [ready, authenticated, navigate, devAuthEnabled]);
  ...
  // DEV BYPASS: Show loading state while redirecting
  if (devAuthEnabled) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-background">
        <div className="text-center">
          <div className="text-lg text-muted-foreground">DEV Mode - Redirecting...</div>
        </div>
      </div>
    );
  }
